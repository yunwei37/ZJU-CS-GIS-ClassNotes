...
struct Message {
    char type; //the type of messgae
    int length; // the length of the total message
    int des;  // using for send messgae to another client
    char content[MESSAGE_SIZE]; // the content of messgae
};
